...
compute_iid_decomposition_survival<-function(t,n,cause,F01t,St,weights,T,delta,marker){
  ...
  # END OF STEP : Compute terms  {\hat{h}_{tij}}_1 
  ################################################
  ...
  return(list(iid_representation_AUC=rep(NA,n),iid_representation_AUCstar=hatIFstar, sdAUC=NA,sdAUCstar=sdAUCstar,
