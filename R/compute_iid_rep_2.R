...
compute_iid_decomposition<-function(t,n,cause,F01t,St,weights,T,delta,marker){
  ...
  if(sum(Controls_2)>0){ compute_iid_decomposition_competing_risks(t,n,cause,F01t,St,weights,T,delta,marker) 
                         }else{ compute_iid_decomposition_survival(t,n,cause,F01t,St,weights,T,delta,marker)
                                }
